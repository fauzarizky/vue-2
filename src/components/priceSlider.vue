<template>
        <transition name="custom" enter-active-class="animate__animated animate__fadeInDown" leave-active-class="animate__animated animate__fadeOutRight"> <!--memanfaatkan event yang dimiliki vue JS @beforeEnter etc-->
